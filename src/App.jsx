...
const NEXUS_DATA = {
  ...
  nodes: [
    ...
    { id: 'voj_node', name: 'Voice of Jesus', x: 60, y: 50, type: 'ministry', color: '#c9a84c', icon: BookOpen, url: url('/voj') }
  ]
};
        ...
        <div className="fixed inset-0 z-[200] flex animate-in">
           ...
           <div className="relative w-72 h-full bg-[#030a03] border-r border-[#00ff41]/20 p-8 flex flex-col space-y-8">
              ...
              <div className="space-y-4">
                 ...
                 <a href="https://voiceofJesusMinistries.com" target="_blank" rel="noreferrer" className="flex items-center gap-4 text-slate-400 hover:text-amber-400 transition-all font-bold text-sm">
